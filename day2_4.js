document.addEventListener('DOMContentLoaded', function() {
    console.log("Day 2 Casualty dashboard initializing...");
...
function ensureStyles() {
    // Add CSS if missing - FIXED to use day2_4.css instead of day3_4.css
    if (!document.querySelector('link[href="day2_4.css"]')) {
        const link = document.createElement('link');
        link.rel = 'stylesheet';
        link.href = 'day2_4.css';
...
function initializeCasualtiesChart() {
    ...
    // Updated data for Day 2 casualties
    const data = {
        labels: ['Chariots', 'Elephants', 'Cavalry', 'Infantry'],
        datasets: [
            {
                label: 'Pandavas',
                data: [8000, 2000, 10000, 70000],
    ...
    console.log("Day 2 Casualties chart initialized");
}
